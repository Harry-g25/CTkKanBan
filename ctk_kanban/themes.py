...
def _customtkinter_defaults() -> dict[str, Any]:
    ...
    return {
        ...
        "card_metadata_fg_color": _color(dropdown["hover_color"]),
        ...
        "card_gap": 8,
        # Card geometry/typography and compact-value limits. Defaults favor
        # comfortable desktop hit targets while keeping the existing compact
        # card structure and information order.
        ...
        "editor_title_font": {"size": 16, "weight": "bold"},
        "editor_status_font": {"size": 9, "weight": "bold"},
        "section_title_font": {"size": 13, "weight": "bold"},
        "field_label_font": {"size": 12, "weight": "bold"},
        "help_text_font": {"size": 12},
        "status_text_font": {"size": 12},
        "editor_input_font": {"size": 13},
        "editor_button_font": {"size": 13},
        "input_height": 40,
        "compact_input_height": 40,
        "input_corner_radius": 9,
        "input_border_width": 1,
        "textbox_height": 105,
        "scrollbar_width": 14,
        "error_text_color": ("#B91C1C", "#FCA5A5"),
        # Custom context-menu geometry and typography.
        ...
        "menu_border_color": _color(frame["border_color"]),
        "menu_corner_radius": 10,
        "menu_border_width": 1,
        "menu_padding": 6,
        "menu_min_width": 128,
        "menu_item_height": 34,
        "menu_item_corner_radius": 7,
        "menu_separator_margin": 7,
        "menu_font": {"size": 12},
    }
